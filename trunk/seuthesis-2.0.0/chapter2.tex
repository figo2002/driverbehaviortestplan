...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.4\linewidth]{traveldecision}
...
不同驾驶人之间行为的差异可以由驾驶人驾驶操作的目标，习惯，熟练程度的差异等多种因素造成。而驾驶人自身，在交通条件，生心理条件发生改变时 会改变自己的驾驶行为而作出适应性的调整，最典型的现象是驾驶人加减速的不对称性。
%
